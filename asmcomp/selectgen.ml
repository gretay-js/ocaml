...
method is_simple_expr = function
  ...
  | Cop(op, args, _) ->
      ...
      | Cxor | Clsl | Clsr | Casr | Cclz _ | Cpopcnt | Ccmpi _ | Caddv | Cadda | Ccmpa _
...
method effects_of exp =
  ...
  | Cop (op, args, _) ->
    let from_op =
      ...
      | Clsl | Clsr | Casr | Cclz _ | Cpopcnt | Ccmpi _ | Caddv | Cadda | Ccmpa _ | Cnegf
...
method select_operation op args _dbg =
  ...
  | (Cclz b, _) -> self#select_arith (Iclz b) args
  | (Cpopcnt, _) -> self#select_arith Ipopcnt args
