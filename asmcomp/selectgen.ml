...
let oper_result_type = function
  ...
  | Caddi | Csubi | Cmuli | Cmulhi | Cdivi | Cmodi |
    Cand | Cor | Cxor | Clsl | Clsr | Casr | Cclz | Cpopcnt |
...
method is_simple_expr = function
  ...
  | Cop(op, args, _) ->
      ...
      | Cxor | Clsl | Clsr | Casr | Cclz | Cpopcnt | Ccmpi _ | Caddv | Cadda | Ccmpa _
...
method effects_of exp =
  ...
  | Cop (op, args, _) ->
    let from_op =
      ...
      | Clsl | Clsr | Casr | Cclz | Cpopcnt | Ccmpi _ | Caddv | Cadda | Ccmpa _ | Cnegf
